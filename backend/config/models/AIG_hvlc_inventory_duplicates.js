// models/aig_hvlc_inventory_duplicates.js
const { DataTypes } = require('sequelize');

module.exports = (sequelize) => {
  const AigHvlcInventoryDuplicates = sequelize.define('aig_hvlc_inventory_duplicates', {
    ticket_number: {
  ...
  return AigHvlcInventoryDuplicates;
};
