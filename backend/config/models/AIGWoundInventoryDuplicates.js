// models/AIGWoundInventoryDuplicates.js
const { DataTypes } = require('sequelize');

module.exports = (sequelize) => {
  const AIGWoundInventoryDuplicates = sequelize.define('aig_wound_inventory_duplicates', {
    ticket_number: {
  ...
  return AIGWoundInventoryDuplicates;
};
