// config/models/A_duplicate_client_claims_details.js
const { DataTypes } = require('sequelize');

module.exports = (sequelize) => {
  const A_duplicate_client_claims_details = sequelize.define('A_duplicate_client_claims_details', {
    claim_id: {
  ...
  return A_duplicate_client_claims_details;
};
