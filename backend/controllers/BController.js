...
const BClientClaimsDetailsModel = require('../config/models/B_client_claims_details');
...
const dbConfigB = {
  ...
  const sequelizeB = new Sequelize(dbConfigB);
...
//     // Use 'A_duplicate_client_claims_details' table for all databases
...
function getModel(sequelizeInstance, modelName) {
    switch (modelName) {
      case 'B_client_claims_details':
        return BClientClaimsDetailsModel(sequelizeInstance);
